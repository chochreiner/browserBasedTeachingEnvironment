...
define('ace/mode/next', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/mode/tcl', 'ace/tokenizer', 'ace/mode/next_highlight_rules', 'ace/mode/matching_brace_outdent', 'ace/range'], function(require, exports, module) {
...
var NextHighlightRules = function() {
    ...
    var builtinFunctions=lang.arrayToMap(("method|new|alias|delete|create|info|property|forward|mixin|require|filter|variablevolatile|configure|copy|cget|delete|info|object|public|eval|destroy|protected|private|require|move|contains").split("|"));
