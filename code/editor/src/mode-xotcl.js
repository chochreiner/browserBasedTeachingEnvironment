...
var XoTclHighlightRules = function() {
    ...
    var builtinFunctions=lang.arrayToMap(("uses|allinstances|parameter|method|new|instmixin|alloc|instparametercmd|instforward|info|create|dealloc|slots|superclass|instinvar|instmixinguard|instfilterguard|unknown|instproc|recreate|instfilter|subst|configure|isclass|residualargs|check|eval|autoname|requireNamespace|isobject|lappend|proc|move|instvar|exists|volatile|istype|array|cleanup|filterguard|filtersearch|filter|contains|append|objectparameter|noinit|hasclass|self|set|parametercmd|mixin|defaultmethod|trace|ismetaclass|ismixin|procsearch|destroy|vwait|uplevel|extractConfigureArg|copy|init|forward|upvar|unset|mixinguard|invar|incr|abstract|classgetExitHandler|setExitHandler|unsetExitHandler|uses|allinstances|parameter|method|new|instmixin|alloc|instparametercmd|instforward|info|create|dealloc|slots|superclass|instinvar|instmixinguard|instfilterguard|unknown|instproc|recreate|instfilter|subst|configure|isclass|residualargs|check|eval|autoname|requireNamespace|isobject|lappend|proc|move|instvar|exists|volatile|istype|array|cleanup|filterguard|filtersearch|filter|contains|append|objectparameter|noinit|hasclass|self|set|parametercmd|mixin|defaultmethod|trace|ismetaclass|ismixin|procsearch|destroy|vwait|uplevel|extractConfigureArg|copy|init|forward|upvar|unset|mixinguard|invar|incr|abstract|class").split("|"));
...
oop.inherits(XoTclHighlightRules, TextHighlightRules);
